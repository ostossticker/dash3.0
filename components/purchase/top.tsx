...
const Purtop = ({val ,suggesting, func,val1,func1,fromdate,funcFrom, setBus ,todate,funcTo,onclick}:purTopProps) => {
                                                    ...
                                                    suggesting.map((op)=>{
                                                        return(
                                                            ...
                                                            item.typeSelect === "business" &&  handleClick(op)
                                                                ...
                                                                {item.typeSelect === "business" && op.purBus }
                                                            </li>
                                                        )
                                                    })
                                                }
