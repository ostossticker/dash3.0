...
const DailySummaries = () => {
  ...
  return (
    <div className={`${darkMode ? "bg-dark-box-color" : "bg-white"} shadow-md rounded-lg ${isOpen || isHover ? "h-[476px]" : "h-[503px]"} px-[30px] pb-[10px]`}>
        <div className='flex items-center pt-[30px] justify-between'>
            <h1 className={`${isOpen || isHover ? "text-[23px]" : "text-[25px]"}  ${darkMode ? "text-dark-lg-color" : "text-[#1a3158]"}`}>Daily</h1>
